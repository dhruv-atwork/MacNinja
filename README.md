...
It allows users to **view, randomize, and restore** their network interface MAC address
...
- `tkinter` - Used to build the graphical user interface (GUI) for user interaction.
